...
function SoftwareEnroll(props) {
  const submitClick = async (type, e) => {
    let Swt_toolname_checker = $('#is_Swt_toolname').val();
    let Swt_demo_site_checker = $('#is_Swt_demo_site').val();
    let Giturl_checker = $('#is_Giturl').val();
    let Comments_checker = $('#is_Comments').val();
    let Swt_function_checker = $('#is_Swt_function').val();
